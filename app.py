...
# ---------------------------------------------------------
# [나만의 일주 해석 사전 - 60갑자 전체 완성판 🌟]
# ---------------------------------------------------------
ilju_data = {
    "갑자": "큰 나무가 물을 머금은 형상. 지혜롭고 학구적이나 다소 고독할 수 있습니다.",
    "을축": "언 땅에 뿌리 내린 화초. 끈기와 인내심이 강하고 생활력이 뛰어납니다.",
    "병인": "태양이 나무를 비추는 형상. 밝고 진취적이며 명예와 성취욕이 강합니다.",
    "정묘": "달빛 아래 핀 꽃. 감수성이 풍부하고 예민하며 예술적 재능이 뛰어납니다.",
    "무진": "거대한 태산의 형상(백호). 포용력이 넓고 묵묵히 자신의 길을 가는 리더십이 있습니다.",
    "기사": "따뜻한 흙. 활동적이고 다재다능하며 사교성이 좋아 인기가 많습니다.",
    "경오": "불 속에서 단련되는 철광석. 원칙주의자이며 미남미녀가 많고 단정합니다.",
    "신미": "메마른 땅 위의 보석. 예리하고 꼼꼼하며 자기 주관과 자존심이 매우 강합니다.",
    "임신": "바위에서 솟아나는 큰 물. 언변이 뛰어나고 두뇌 회전이 빠르며 스케일이 큽니다.",
    "계유": "맑은 물결 속에 잠긴 보석. 직관력이 뛰어나고 기억력이 좋으며 섬세합니다.",
    "갑술": "척박한 땅에 뿌리 내린 나무. 책임감이 강하고 재물에 대한 감각이 뛰어납니다.",
    "을해": "물 위에 떠 있는 수초. 유연하고 지혜로우며 방랑벽이나 역마살이 있을 수 있습니다.",
    "병자": "호수 위에 뜬 태양. 겉으로는 밝으나 속은 비밀이 많고 이상이 높습니다.",
    "정축": "추운 겨울의 화로. 인내심이 강하고 희생정신이 있으며 재물 모으는 재주가 있습니다.",
    "무인": "산속의 호랑이. 스케일이 크고 명예를 중시하며 독립심이 매우 강합니다.",
    "기묘": "들판의 토끼. 인정이 많고 다정하며 실속을 잘 챙기는 스타일입니다.",
    "경진": "흙 속에서 캐낸 원석(괴강). 뚝심이 강하고 스케일이 크며 결단력이 있습니다.",
    "신사": "용광로 속의 보석. 예리하고 섬세하며 내면에 뜨거운 열정을 품고 있습니다.",
    "임오": "넓은 호수 위로 달리는 말. 다재다능하고 친화력이 좋으며 재물운이 밝습니다.",
    "계미": "여름날의 소나기. 부드러워 보이지만 속은 강단이 있고 예민한 구석이 있습니다.",
    "갑신": "바위산의 소나무. 재주가 많고 임기응변에 능하며 다재다능한 팔방미인입니다.",
    "을유": "돌 위에 핀 꽃. 환경에 적응하는 능력이 뛰어나며 결단력과 맺고 끊음이 확실합니다.",
    "병술": "해 질 녘의 태양(백호). 화려함을 좋아하고 예술적 감각이 있으며 열정적입니다.",
    "정해": "호수 위의 달빛. 다정다감하고 영감이 뛰어나며 내면의 세계를 중시합니다.",
    "무자": "한밤중의 산. 재물에 대한 집착이 강하고 꼼꼼하며 알뜰한 성품입니다.",
    "기축": "한겨울의 꽁꽁 언 땅. 묵묵하고 끈기가 있으며 대기만성형의 끈질긴 성향입니다.",
    "경인": "큰 나무를 베는 도끼. 활동적이고 개척 정신이 강하며 재물을 향한 추진력이 좋습니다.",
    "신묘": "예리한 낫으로 다듬는 화초. 손재주가 뛰어나고 섬세하며 멋 부리기를 좋아합니다.",
    "임진": "큰 바다의 흑룡(괴강). 스케일이 매우 크고 카리스마가 있으며 속을 알기 어렵습니다.",
    "계사": "봄날의 이슬비. 총명하고 다정다감하며 재물과 명예에 대한 감각이 탁월합니다.",
    "갑오": "불타는 나무. 표현력이 뛰어나고 언변이 좋으며 다소 급한 성격을 가졌습니다.",
    "을미": "메마른 땅의 잡초(백호). 생존력이 강하고 알뜰하며 자기 몫을 확실히 챙깁니다.",
    "병신": "바위 위의 태양. 다재다능하고 눈치가 빠르며 예술이나 기술 분야에 능합니다.",
    "정유": "밤하늘의 촛불. 섬세하고 예술적 감각이 탁월하며 재물을 다루는 솜씨가 좋습니다.",
    "무술": "첩첩산중의 태산(괴강). 책임감과 자존심이 강하고 의리를 중시하는 고집쟁이입니다.",
    "기해": "습한 옥토. 온화하고 융통성이 좋으며 재물을 은밀하게 잘 모읍니다.",
    "경자": "맑은 물에 씻긴 칼. 지혜롭고 깔끔하며 표현력이 좋고 예리한 판단력을 지녔습니다.",
    "신축": "진흙 속의 보석. 인내심이 깊고 완벽주의 성향이 강하며 끈기로 승부합니다.",
    "임인": "넓은 강변의 숲. 학구적이고 호기심이 많으며 식복(먹을 복)이 두터운 사주입니다.",
    "계묘": "봄비 맞은 화초. 다정하고 부드러우며 감수성이 풍부해 예술 방면에 소질이 있습니다.",
    "갑진": "비옥한 땅에 뿌리 내린 큰 나무(백호). 리더십이 강하고 배포가 크며 성취욕이 남다릅니다.",
    "을사": "태양을 향해 피어나는 꽃. 표현력이 화려하고 말솜씨가 뛰어나며 활동적입니다.",
    "병오": "한여름의 태양(양인). 에너지의 끝판왕! 열정적이고 카리스마 넘치며 뒤끝이 없습니다.",
    "정미": "뜨거운 사막의 모닥불(양인). 독립심이 강하고 다소 욱하는 면이 있으나 뒤끝 없이 순수합니다.",
    "무신": "광산을 품은 산. 재주가 뛰어나고 임기응변에 강하며 의식주가 풍부합니다.",
    "기유": "황금 품은 흙. 깔끔하고 예리하며 예술적 재능이 뛰어나고 미식가가 많습니다.",
    "경술": "철광석을 품은 산(괴강). 결단력과 의리가 대단하며 리더십과 카리스마가 돋보입니다.",
    "신해": "맑은 물에 씻긴 보석. 두뇌가 명석하고 언변이 뛰어나며 예술적 감수성이 탁월합니다.",
    "임자": "깊고 깊은 바다(양인). 속을 알 수 없는 지혜의 소유자이며 스케일과 고집이 대단합니다.",
    "계축": "겨울비 내리는 언 땅(백호). 외유내강형으로 끈기가 대단하고 명예욕과 자존심이 강합니다.",
    "갑인": "하늘 높이 뻗은 거목(건록). 주관이 뚜렷하고 리더십이 있으며 꺾일지언정 굽히지 않습니다.",
    "을묘": "넓게 퍼진 화초(건록). 고집이 세고 끈질기며 뛰어난 생존력과 사교성을 지녔습니다.",
    "병진": "태양 아래 비옥한 땅. 스케일이 크고 명예와 권력을 지향하며 포용력이 돋보입니다.",
    "정사": "맹렬하게 타오르는 용광로(제왕). 열정이 넘치고 승부욕이 강하며 자기 주관이 확고합니다.",
    "무오": "용암을 품은 화산(양인). 에너지가 무한하고 추진력이 강하며 매사에 열정적입니다.",
    "기미": "건조한 한여름의 땅. 자존심과 고집이 강하고 독립적이며 묵묵히 일을 추진합니다.",
    "경신": "거대한 철광석 산(건록). 의리와 결단력의 상징! 뚝심이 강하고 한번 결정하면 밀어붙입니다.",
    "신유": "정교하게 다듬어진 보석(건록). 완벽주의자이며 호불호가 확실하고 깔끔한 미남미녀가 많습니다.",
    "임술": "큰 호수를 품은 산(백호). 직관력과 영감이 뛰어나며 재물에 대한 끈질긴 성취욕이 있습니다.",
    "계해": "끝없이 흐르는 강물(제왕). 지혜가 깊고 포용력이 넓으며 자유를 갈망하는 성향이 짙습니다."
}
